...
%%% Chapters - Clinical Report %%%
\include{Chapters/01-Assessment Process}
\include{Chapters/02-Treatment Process}
\include{Chapters/03-Therapeutic Process}
\include{Chapters/04-Reflection Process}
...
%%% Appendices %%%
\appendix
\include{Matter/08-Appendices}
\include{Chapters/Appendices/00-Note}
