...
The Australian healthcare system currently addresses infertility through medical interventions including assisted reproductive technologies, yet psychological support remains fragmented and inadequately integrated within fertility care pathways. This project proposes implementing \textit{Emotionally Focused Couples Therapy}, a manualized intervention based on attachment theory that restructures emotional responses and interaction patterns through systematic therapeutic processes \parencite{Johnson2019}. The intervention addresses both individual psychological distress and dyadic functioning through three operationalized stages: cycle deescalation, attachment restructuring, and consolidation of secure bonding patterns.
...
\subsection{Empirical Perspectives}
