...
\begin{landscape}
\thispagestyle{empty}
\pagestyle{empty}  % Remove headers/footers for all landscape pages

% Use longtable for multi-page tables
\begin{longtable}{p{2.5cm}p{2cm}p{2.5cm}p{1.5cm}p{7cm}}
    ...
    \textcite{Tracy2023adherence} & Registry analysis & 17 \gls{branz} units & 10,884 patients & Allied health assessment within 48hr achieved in 97\% of cases with structured protocols \\
