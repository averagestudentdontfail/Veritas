...
\textbf{Background:} Acute burn injury represents one of the most complex medical emergencies, requiring coordinated intervention across multiple healthcare disciplines. While \gls{multidisciplinary} approaches have become standard in Australasian \glspl{burnunit} since the early 2000s, the empirical evidence base comparing these models to traditional single-discipline care requires systematic evaluation.
