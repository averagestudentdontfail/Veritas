...
The standardized data extraction captured study characteristics, population details, intervention descriptions, outcome measures, and results. Quality assessment employed Oxford Centre for Evidence-Based Medicine criteria, evaluating study design, risk of bias, sample size, outcome measurement, and statistical analysis appropriateness.

\section{PRISMA Flow Diagram}

The search and selection process followed \gls{prisma} guidelines to ensure transparent and reproducible methodology. \autoref{fig:prisma} illustrates the flow of studies through each phase of the systematic review.

% Using the new landscapefigure environment
